...
import { fetchProducts, type IProducts } from "../../../../store/adminProductSlice";
...
const ProductTable = () => {
  ...
  const openEditModal = useCallback((product: IProducts) => {
      ...
      <div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <div className="flex items-center pr-4">
            <button onClick={openAddModal} className="bg-blue-500 rounded text-white p-2">
              + Add Product
            </button>
          </div>
        </div>
                ...
                return (
                  <tr key={product.productId}>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <Link to={`/admin/products/${product.productId}`}>{product.productId}</Link>
                    </td>
