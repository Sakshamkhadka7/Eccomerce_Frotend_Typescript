...
// import { cancelOrder } from "../../../store/checkoutSlice";
import IndexAdmin from "../IndexAdmin";
import { fetchAllOrdersDetails } from "../../../store/adminOrderSlice";
import { OrderStaus } from "../../myOrders/type";
...
const AdminOrderDetails = () => {
  ...
  useEffect(() => {
    if (id) {
      dispatch(fetchAllOrdersDetails(id));
    }
  }, []);
  ...
  const handleOrderChangeStatus=(e:ChangeEvent<HTMLSelectElement>)=>{
            ...
            <div className="flex flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0">
              ...
              <div className="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                ...
                <div className="flex w-full justify-center items-center md:justify-start md:items-start">
                  {orderDetails[0]?.Order?.orderStaus !==
                    OrderStaus.Cancelled && (
                    <>
                      <label htmlFor="">Change Order Status</label>
                      <select onChange={handleOrderChangeStatus} name="" id="">
                        <option value="pending">pending</option>
                        <option value="delivered">delivered</option>
                        <option value="ontheway">ontheway</option>
                        <option value="prepration">preparation</option>
