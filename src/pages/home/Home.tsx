...
function Home() {
  ...
  <div className="lg:w-1/2 text-center lg:text-left">
    ...
    <div className="mt-10 flex flex-col sm:flex-row justify-center lg:justify-start gap-5">
      <button className="px-8 py-4 rounded-xl bg-pink-600 text-white font-semibold shadow-lg hover:bg-pink-700 transition-all duration-300 hover:scale-105">
        Shop Now
      </button>

      <button className="px-8 py-4 rounded-xl border-2 border-pink-600 text-pink-600 font-semibold hover:bg-pink-600 hover:text-white transition-all duration-300">
        Explore Collection
      </button>
    </div>
  ...
  <div className="container mx-auto px-6 lg:px-12">
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div>
        ...
        <button className="mt-10 px-8 py-4 rounded-xl bg-pink-600 text-white font-semibold hover:bg-pink-700 transition duration-300 shadow-lg">
          Explore Collection
        </button>
